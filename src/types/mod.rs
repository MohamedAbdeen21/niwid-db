...
impl Primitive for Bool {
    fn add(self, _other: Self) -> Self {
        // Boolean operations don't make sense for addition, etc.
        // Implement as needed or return an error
        unimplemented!()
    }
    fn subtract(self, _other: Self) -> Self {
        // Boolean operations don't make sense for subtraction, etc.
        // Implement as needed or return an error
        unimplemented!()
    }
    fn multiply(self, other: Self) -> Self {
    ...
    fn divide(self, _other: Self) -> Self {
        // Boolean operations don't make sense for division, etc.
        // Implement as needed or return an error
        unimplemented!()
    }
    fn to_bytes(&self) -> Box<[u8]> {
